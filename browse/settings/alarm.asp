...
<div class="alarmName" style="margin-top:1px;"><label>Alarm configuration</label></div>
<div class="alarmContent" style="height:176px;">
<div class="alarmDiv">
	...
	<div id="alarmIn1" class="alarmUnitDiv">
		<div>
			...
			<label>I/O&nbsp;Input 1:</label><input type="hidden" name="flag" value="1" />
		</div>
		<select name="Alarmin1Select" id="Alarmin1Select" class="alarmSelect" onchange="alarmAccessFormSubmit();">
              <option value="0">Grounded circuit</option>
              <option value="1">Open circuit</option>
        </select>
	</div>
	...
	<div class="alarmUnitDiv" id="pirDIV">
		...
		<div>
			<label id="pirLable">PIR-MD</label>
		</div>
		<div>
	...
	<input type="button" class="ButtonSet" value=" Save " onclick="alarmParaSetSubmit();"/>
	</form>
  </div>
...
<div class="alarmName"><label>Alarm out relay</label></div>
<form name="AlarmForm" id="AlarmForm" target="hideFrame" method="post" action="/form/alarmparaCfg">
...
<table id="AlarmOutTable" align="center" cellpadding="0" cellspacing="0" class="alarmTable" style="visibility:hidden">
		  ...
		  <input type="hidden" id="UsdUsb" value='<%SDGet("USB","net");%>' />
		   <tr id="outTr">
			<td width="150">&nbsp;</td>
			<td width="75">I/O out 1</td>
			<td width="71">I/O out 2</td>
			<td width="69">Mail</td>
			<td width="70" id="jsSDalarm">SD card</td>
			<td width="62">FTP</td>
			<td width="62">TCP</td>
			<td width="62">Audio</td>
			<td width="71">Select all</td>
		  </tr>	  
		  
		  <tr id="trIn1">
			<td>&nbsp;I/O Input 1<%alarmparaGet("Access1","net");%></td>
		  ...
		  <tr id="trIn2">
			<td>&nbsp;I/O Input 2<%alarmparaGet("Access2","net");%></td>
		  ...
		  <tr>
			<td>&nbsp;Motion area<%alarmparaGet("mAccess1","net");%></td>
		  ...
		  <tr style="display:none">
			<td>&nbsp;Motion area 2<%alarmparaGet("mAccess2","net");%></td>
		  ...
		  <tr style="display:none">
			<td>&nbsp;Motion area 3<%alarmparaGet("mAccess3","net");%></td>
		  ...
		  <tr style="display:none">
			<td>&nbsp;Motion area 4<%alarmparaGet("mAccess4","net");%></td>
		  ...
		  <tr id="Intell">
			<td>&nbsp;Intelligent detect<%alarmparaGet("mAccess5","net");%></td>
          ...
          <tr id="SDOut">
			<td>&nbsp;SD card out<%alarmparaGet("SDAccess","net");%></td>
          ...
          <tr id="netdown">
			<td>&nbsp;Network link down<%alarmparaGet("NetlostAccess","net");%></td>
  ...
  <input id="setAlarm" type="submit" class="ButtonSet" value=" Save "/>
  </div>
</div>
</form>  

<div class="alarmName"><label>Alarm schedule</label></div>
...
<table id="CalendarTable" align="center" cellpadding="0" cellspacing="0" class="alarmTable">
	...
	<input type="hidden" name="flag" value="3"/>
 	<tr>
		<td width="149"><%alarmparaGet("AlarmCalendarParm","net");%></td>
		<td width="235">Start time </td>
		<td width="236">End time </td>
	</tr>
	
	<tr>
		<td><input name="cbCa0" type="hidden" id="cbCa0" value="" />
		  &nbsp;<input name="ccbCa0" type="checkbox" id="ccbCa0" onclick="checkCalender(0);" />
		  Sun.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa1" type="checkbox" id="ccbCa1" onclick="checkCalender(1);" />
		Mon.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa2" type="checkbox" id="ccbCa2" onclick="checkCalender(2);" />
		Tue.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa3" type="checkbox" id="ccbCa3"  onclick="checkCalender(3);" />
		Wed.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa4" type="checkbox" id="ccbCa4"  onclick="checkCalender(4);" />
		Thu.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa5" type="checkbox" id="ccbCa5"  onclick="checkCalender(5);" />
		Fri.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa6" type="checkbox" id="ccbCa6" onclick="checkCalender(6);" />
		Sat.</td>
	...
	<tr>
		...
		&nbsp;<input name="ccbCa7" type="checkbox" id="ccbCa7" onclick="checkCalender(7);checkEveryDay();" />
		Everyday</td>
  ...
  <input type="button" class="ButtonSet" value="Save" onclick="setAlarmCalendar();" />
  </div>
