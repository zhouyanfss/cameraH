...
function h264VideoSizeSet()
{
	...
	if(obj.width > parent.mainFrame.videomainFrame.document.documentElement.clientWidth)
	{
		parent.mainFrame.videomainFrame.document.getElementById("bottomArea").style.width  = obj.width+"px";
	}
	else{
		parent.mainFrame.videomainFrame.document.getElementById("bottomArea").style.width = "100%";
	}
}
